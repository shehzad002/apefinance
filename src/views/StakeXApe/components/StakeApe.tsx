...
const StakeApe: React.FC<StakeProps> = ({}) => {
  const tokenName = "APE"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.ape[97])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`APE Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
