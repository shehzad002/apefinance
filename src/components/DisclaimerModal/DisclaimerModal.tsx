...
const DisclaimerModal: React.FC<DisclaimerModal> = ({
  ...
  const modalContent = useMemo(() => {
    if (step === 'disclaimer') {
      return (
        <div>
          ...
          <p> Omakase Bar will be the home of our new frontend, and provides
              an interface for all interactions with the ApeSwap protocol.
          </p>
          <p> Development will be on going, and apeswapclassic will still
      ...
      return (
        <div>
          <StyledLink target="_blank" href="https://apeswap.fi">
